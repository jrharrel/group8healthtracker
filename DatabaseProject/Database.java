...
class Database{	
	...
	static List<LoginRecord> loginArray = new ArrayList<LoginRecord>();
	static List<SubmitData> dataArray = new ArrayList<SubmitData>();
	static FileReader databaseReader;
	static FileWriter databaseWriter = new FileWriter();
	...
	public static void addToLogin(LoginRecord recordPassed ) //This is for when logins are created
	{
		loginArray.add(recordPassed);
		databaseReader.setLoginPieces(loginArray);
	}
	
	public static  void addToData(SubmitData recordPassed)	//This is for when data is Submitted
	{
